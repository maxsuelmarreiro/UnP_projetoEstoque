            ...
            <div id="inserir" class="modal modal-fixed-footer">
                <form id="form" action="" method="post" class="col s12">
                    <div class="modal-content">
                        ...
                        <input type="hidden" name="operacao" value="produto">
                        <div class="row">
                            <div class="input-field col s12">
                                <input id="um" name="nome" id="first_name" type="text" class="validate">
                                <label for="first_name">Nome</label>
                            </div>
                            <div class="input-field col s12">
                                <textarea id="dois" id="textarea1" name="descricao" class="materialize-textarea"></textarea>
                    ...
                    jQuery.ajax({
                        ...
                        success: function(data)
                        {
                            ...
                            if(data == 'Cadastrado com sucesso!'){
                                ...
                                exibirConteudo("produto"); //atualiza tabela
                            }else{
